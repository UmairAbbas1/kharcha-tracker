  ...
  return (
    <div className="flex items-center gap-2">
      <button onClick={() => shift(-1)}
        className="w-7 h-7 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center transition"
        style={{ color: 'var(--color-slate)' }}>
        <ChevronLeft size={15} />
      </button>
      <span className="text-sm font-bold w-36 text-center" style={{ color: 'var(--color-ink)' }}>
        {label}
      </span>
      <button onClick={() => shift(1)}
        className="w-7 h-7 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center transition"
...
function ProgressBar({ spent, budget }) {
  ...
  return (
    <div className="mt-2">
      <div className="flex justify-between text-xs mb-1" style={{ color: 'var(--color-slate)' }}>
...
function BudgetRow({ label, color, icon, spent, budget, onSave, onDelete }) {
  ...
  return (
    <div className="rounded-xl border p-4 hover:bg-white/80 dark:hover:bg-gray-900/10 transition"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-xs font-bold" style={{ color: 'var(--color-slate)' }}>Rs</span>
          <input
            ref={inputRef}
            ...
            style={{ borderColor: 'var(--color-border)', color: 'var(--color-ink)',
                     background: 'var(--color-card)', boxShadow: ring }}
          />
          {budget > 0 && (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold" style={{ color: 'var(--color-ink)' }}>Budgets</h1>
          </div>
        ...
        {loading ? (
          ...
          <div className="card p-6">
            ...
            <p className="text-center text-xs mt-5" style={{ color: 'var(--color-slate)' }}>
              Type an amount and press <kbd className="bg-gray-100 px-1 rounded dark:bg-gray-800">Enter</kbd> or
